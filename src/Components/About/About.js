...
const About = () => {
  ...
  <div className="card-body">
    ...
    <h5 className="card-title">Antor Mental Health Care</h5>
    <p className="card-text">Antor Mental Health Care has been founded with the vision to be the nation’s leading community-based mental health institute dedicated to promoting mental health as a pivotal of overall wellness.
